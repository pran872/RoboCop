...
class Robot(object):
    ...
    def quick_scan_for_blob(self, code_ids: list, pix_thresholds = [60]):
        ...
        angles = [random_dir*i for i in [10, 20, 30, 40, 50, 60, 70, 80, 90]]
    ...
    def body_search(self):
        ...
        for i in range(12):
            ...
            end_blob = self.get_snap(self.end_id, pix_thresh=500)
            square_blob = self.get_snap(self.square_id, pix_thresh=2500)
            if end_blob or square_blob:
                print("Found in first turn")
                return

        self.quick_scan_for_blob([self.end_id, self.square_id], pix_thresholds=[500, 2500])
        self.servo.set_angle(0)
    ...
    def go_robot(self, speed=0.2, stop_cm=10):
        ...
        while True:
            ...
            square_blob = self.get_snap(self.square_id, closest=True, pix_thresh=2500)
            end_blob = self.get_snap(self.end_id, closest=True, pix_thresh=500)
            ...
            if end_blob:
                ...
                for i in range(5):
                    ...
                    target_blob = self.quick_scan_for_blob([4, 1], pix_thresholds=[500, 2500])
                    # target_blob = None
                    ...
                    if target_blob:
                        ...
                        if target_blob.code() == 1: # square code
                            ...
                            pix_thresh=500
                        still_turn_body = self.align_body_and_eyes(target_blob.code(), pix_thresh=pix_thresh)
...
if __name__ == "__main__":
    ...
    thresholds = [
        ...
        # (34, 50, -9, 16, -40, -22), # blue 1
        # (34, 50, -9, 16, -49, -32), # blue2
        # (0, 0, 0, 0, 0, 0), # obstacle
        # (37, 52, -32, -13, -5, 26)
        # # (0, 0, 0, 0, 0, 0), # sprite
        # # (36, 53, 13, 25, -20, -8), # pink line
        # (40, 44, 19, 25, -15, -8), # pink line
