...
class Robot(object):
    ...
    def __init__(self, thresholds, gain, p_steer=1.1, d_steer=0.005, p=0.18, i=0, d=0, imax=0.01):
        ...
        # Blob IDs
        self.square = {"id": 1, "pix_thresh": 4000}
        self.end = {"id": 2, "pix_thresh": 2000}
    ...
    def quick_scan_for_blob(self, targets_list: list, bias=None):
        if bias is not None:
            dir_bias = bias
        else:
    ...
    def body_search(self, bias=None):
        self.servo.set_angle(0)
        if bias is not None:
            turn_bias = [bias, bias*-1]
        else:
        ...
        self.quick_scan_for_blob([self.end, self.square], bias=bias)
        self.servo.set_angle(0)
    ...
    def go_robot(self, speed=0.2, stop_cm=10, bias=None):
        time.sleep(1)
        ...
        while True:
            ...
            if end_blob:
                ...
                if not target_blob:
                    ...
                    target_blob = self.quick_scan_for_blob([self.end, self.square], bias=bias)
...
if __name__ == "__main__":
    ...
    try:
        robot.go_robot(speed=0.1, bias=-1)
