...
class Robot(object):
    ...
    def body_search(self):
        ...
        self.quick_scan_for_blob([self.end_id, self.square_id], pix_thresholds=[1000, 2500])
        ...
        while True:
            ...
            if end_blob:
                ...
                for i in range(5):
                    ...
                    target_blob = self.quick_scan_for_blob([4, 1], pix_thresholds=[1000, 2500])
                    # target_blob = None
