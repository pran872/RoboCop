...
if __name__ == "__main__":
    ...
    sensor.set_auto_gain(False, gain_db = 5)  # can change the gain depending to the brightnes;
    ...
    thresholds = [
    #(34, 45, 32, 60, -97, -70),#gain 20 mid blue
    #(3, 22, 0, 53, -57, -32), # gain 10 left blue
    #(47, 57, 54, 73, 28, 66),
    # (16, 32, -8, 52, 19, 42),
    # (11, 23, 21, 46, -68, -44)
    (35, 54, 48, 87, -4, 67),
